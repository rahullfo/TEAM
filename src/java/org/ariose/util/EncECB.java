 ...
 */
public class EncECB extends Enc
{
    ...
    public EncECB(byte[] key, int ofs, int len)
    {
    ...
    public static boolean selfTest()
    {
        ...
        testbf1 = new EncECB(TESTKEY1, 0, TESTKEY1.length);
        ...
        testbf2 = new EncECB(TESTKEY2.getBytes(), 0, TESTKEY2.length());
